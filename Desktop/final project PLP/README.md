Hello my name is Matshavha Patrecia Thanyani , a full stack developer. The founder of EDUZONE 
...
# How to run 
- Clone te repository: https://github.com/thanyani98/Final-project-plp.git
- cd Eduzone
